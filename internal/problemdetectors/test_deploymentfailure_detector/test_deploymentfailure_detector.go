package test_deploymentfailure_detector
...
var detectorName = "Test Detector for deployment failures"

// compiler to validate if the struct indeed implements the interface
var _ problem.Detector = (*testDeploymentFailureDetector)(nil)

func New(i *problem.DetectorCreationInput) (problem.Detector, error) {

	return testDeploymentFailureDetector{
		name: detectorName,
	}, nil
}

type testDeploymentFailureDetector struct {
	//inputs
...
func (d testDeploymentFailureDetector) Name() string {
	return d.name
}

func (d testDeploymentFailureDetector) Domain() problem.DomainName {
	return problem.DeploymentFailuresDomain
}

func (d testDeploymentFailureDetector) Detect(ctx context.Context) ([]problem.Problem, error) {

	fmt.Println("Running -> testDeploymentFailureDetector")
	...
	return []problem.Problem{
		{
			...
			Tags:        []string{},
			Docs:        []*url.URL{},
			DomainName:  problem.DeploymentFailuresDomain,
